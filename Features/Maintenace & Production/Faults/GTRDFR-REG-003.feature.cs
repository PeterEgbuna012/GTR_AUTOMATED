...
namespace GTR_AUTOMATED.Features.MaintenaceProduction.Faults
{
    ...
    [global::NUnit.Framework.DescriptionAttribute("1.2.3 - Fault Raised and closed by Fault Reporter")]
    ...
    public partial class _1_2_3_FaultRaisedAndClosedByFaultReporterFeature
    {
        ...
        private static global::Reqnroll.FeatureInfo featureInfo = new global::Reqnroll.FeatureInfo(new global::System.Globalization.CultureInfo("en-US"), "Features/Maintenace & Production/Faults", "1.2.3 - Fault Raised and closed by Fault Reporter", "You have received a call from a driver. You have assessed the issue over the phon" +
                "e and have resolved it. A Fault entry needs to be raised and completed. ", global::Reqnroll.ProgrammingLanguage.CSharp, featureTags, InitializeCucumberMessages());
...
#line hidden
        ...
        {
            return new global::Reqnroll.Formatters.RuntimeSupport.FeatureLevelCucumberMessages("Features/Maintenace & Production/Faults/GTRDFR-REG-003.feature.ndjson", 3);
        }
        
        [global::NUnit.Framework.TestAttribute()]
        [global::NUnit.Framework.DescriptionAttribute("Fault Raised and closed by Fault Reporter")]
        [global::NUnit.Framework.CategoryAttribute("1.2.3-FaultRaisedandclosedbyFaultReporter")]
        [global::NUnit.Framework.TestCaseAttribute("Fault Analyst", "0", null)]
        public async global::System.Threading.Tasks.Task FaultRaisedAndClosedByFaultReporter(string role, string @__pickleIndex, string[] exampleTags)
        {
            ...
            global::Reqnroll.ScenarioInfo scenarioInfo = new global::Reqnroll.ScenarioInfo("Fault Raised and closed by Fault Reporter", null, tagsOfScenario, argumentsOfScenario, featureTags, pickleIndex);
...
#line hidden
                ...
                table274.AddRow(new string[] {
                            "387102"});
#line 12
    await testRunner.AndAsync("I filter table location:", ((string)(null)), table274, "And ");
#line hidden
#line 15
...
#line 22
    await testRunner.AndAsync("I enter following data:", ((string)(null)), table275, "And ");
#line hidden
#line 25
...
#line hidden
                ...
                table276.AddRow(new string[] {
                            "TAUTO"});
#line 27
    await testRunner.AndAsync("I enter following data to Headcode:", ((string)(null)), table276, "And ");
#line hidden
#line 30
