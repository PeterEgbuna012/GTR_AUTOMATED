...
namespace GTR_AUTOMATED.Features.MaintenaceProduction.Faults
{
    ...
    [global::NUnit.Framework.DescriptionAttribute("1.2.2 - Raising a duplicate Fault in Fault Reporting")]
    ...
    public partial class _1_2_2_RaisingADuplicateFaultInFaultReportingFeature
    {
        ...
        private static global::Reqnroll.FeatureInfo featureInfo = new global::Reqnroll.FeatureInfo(new global::System.Globalization.CultureInfo("en-US"), "Features/Maintenace & Production/Faults", "1.2.2 - Raising a duplicate Fault in Fault Reporting", "You have received a call from a driver. You are entering the information into the" +
                " system and a check is required if the ticket is a duplicate.", global::Reqnroll.ProgrammingLanguage.CSharp, featureTags, InitializeCucumberMessages());
...
#line hidden
        ...
        {
            return new global::Reqnroll.Formatters.RuntimeSupport.FeatureLevelCucumberMessages("Features/Maintenace & Production/Faults/GTRDFR-REG-002.feature.ndjson", 3);
        }
        
        [global::NUnit.Framework.TestAttribute()]
        [global::NUnit.Framework.DescriptionAttribute("Raising a duplicate Fault in Fault Reporting")]
        [global::NUnit.Framework.CategoryAttribute("1.2.2-RaisingaduplicateFaultinFaultReporting")]
        [global::NUnit.Framework.TestCaseAttribute("Fault Analyst", "0", null)]
        public async global::System.Threading.Tasks.Task RaisingADuplicateFaultInFaultReporting(string role, string @__pickleIndex, string[] exampleTags)
        {
            ...
            global::Reqnroll.ScenarioInfo scenarioInfo = new global::Reqnroll.ScenarioInfo("Raising a duplicate Fault in Fault Reporting", null, tagsOfScenario, argumentsOfScenario, featureTags, pickleIndex);
...
#line hidden
                ...
                table271.AddRow(new string[] {
                            "387111"});
#line 13
    await testRunner.AndAsync("I filter table location:", ((string)(null)), table271, "And ");
#line hidden
#line 16
...
#line hidden
                ...
                table272.AddRow(new string[] {
                            "TAUTO"});
#line 27
    await testRunner.AndAsync("I enter following data to Headcode:", ((string)(null)), table272, "And ");
#line hidden
...
#line 30
    await testRunner.AndAsync("I enter following data:", ((string)(null)), table273, "And ");
#line hidden
#line 33
