Feature: 2.0.4 - Completing a CM Work Order for Review

You have been given a Work Order to complete.
...
Scenario: 01) Create a CM Work Order
	...
	And I take screenshot of Completing a CM Work Order for Review test Scenario two
 ...
 Given I sign as <role>
  ...
  And I filter table CM Work Order:
      | Description | Status  |
      | Completing a CM Work Order for Review | =WAIT-REV |
  ...
  And I save record
  And I take screenshot of Completing a CM Work Order for Review test Scenario one
...
Scenario: 03) Completing a CM Work Order for Review
	...
	And I filter table CM:
		...
		| Completing a CM Work Order for Review | =SCHEDULED | =CM |
	And I select no. 1 record from CM Work Order table records
	And I press route the workflow button
    ...
    And I take screenshot of Completing a CM Work Order for Review test Scenario three
