...
namespace GTR_AUTOMATED.Features.MaintenaceProduction.EM
{
    ...
    [global::NUnit.Framework.DescriptionAttribute("0.0.6 - Rejecting an EM Work Order")]
    [global::NUnit.Framework.FixtureLifeCycleAttribute(global::NUnit.Framework.LifeCycle.InstancePerTestCase)]
    public partial class _0_0_6_RejectingAnEMWorkOrderFeature
    {
        ...
        private static global::Reqnroll.FeatureInfo featureInfo = new global::Reqnroll.FeatureInfo(new global::System.Globalization.CultureInfo("en-US"), "Features/Maintenace & Production/EM", "0.0.6 - Rejecting an EM Work Order", "You are reviewing Completed Work in your start centre and want to reject it to be" +
                " reviewed by the person who completed the work", global::Reqnroll.ProgrammingLanguage.CSharp, featureTags, InitializeCucumberMessages());
        
#line 1 "GTRDWM-REG-006.feature"
#line hidden
        ...
        {
            return new global::Reqnroll.Formatters.RuntimeSupport.FeatureLevelCucumberMessages("Features/Maintenace & Production/EM/GTRDWM-REG-006.feature.ndjson", 7);
        }
        
        [global::NUnit.Framework.TestAttribute()]
        [global::NUnit.Framework.DescriptionAttribute("01) Create a EM Work Order")]
        [global::NUnit.Framework.CategoryAttribute("Feature:0.0.6-RejectinganEMWorkOrder")]
...
#line hidden
                ...
                table245.AddRow(new string[] {
                            "377458"});
#line 12
    await testRunner.AndAsync("I filter table Location:", ((string)(null)), table245, "And ");
#line hidden
#line 15
...
#line hidden
                ...
                table246.AddRow(new string[] {
                            "BRIGHTON"});
#line 23
    await testRunner.AndAsync("I filter table Repair Facility:", ((string)(null)), table246, "And ");
#line hidden
#line 26
...
#line 28
    await testRunner.AndAsync("I filter table Reported Priority:", ((string)(null)), table247, "And ");
#line hidden
#line 31
...
#line hidden
                ...
                table248.AddRow(new string[] {
                            "TAUTO"});
#line 32
    await testRunner.AndAsync("I enter following data to Headcode:", ((string)(null)), table248, "And ");
#line hidden
                global::Reqnroll.Table table249 = new global::Reqnroll.Table(new string[] {
                            "Summary",
                            "Details"});
                table249.AddRow(new string[] {
                            "Rejecting an EM Work Order",
                            "AUTO TEST EM WORK ORDER"});
#line 35
    await testRunner.AndAsync("I enter following data:", ((string)(null)), table249, "And ");
#line hidden
#line 38
...
#line hidden
#line 47
    await testRunner.AndAsync("I take screenshot of Rejecting an EM Work Order scenario one", ((string)(null)), ((global::Reqnroll.Table)(null)), "And ");
#line hidden
            }
...
#line hidden
                ...
                table250.AddRow(new string[] {
                            ...
                            "=EM"});
#line 60
     await testRunner.WhenAsync("I filter table EM:", ((string)(null)), table250, "When ");
#line hidden
#line 63
...
#line hidden
#line 68
 await testRunner.AndAsync("I take screenshot of Rejecting an EM Work Order scenario two", ((string)(null)), ((global::Reqnroll.Table)(null)), "And ");
#line hidden
            }
            await this.ScenarioCleanupAsync();
        }
...
#line hidden
                ...
                table251.AddRow(new string[] {
                            ...
                            "=EM"});
#line 81
      await testRunner.WhenAsync("I filter table EM:", ((string)(null)), table251, "When ");
#line hidden
#line 84
     await testRunner.AndAsync("I select no. 1 record from EM table", ((string)(null)), ((global::Reqnroll.Table)(null)), "And ");
#line hidden
...
#line hidden
                ...
                table252.AddRow(new string[] {
                            "ABRACE"});
#line 88
     await testRunner.AndAsync("I filter table labor:", ((string)(null)), table252, "And ");
#line hidden
#line 91
...
#line hidden
#line 97
  await testRunner.AndAsync("I take screenshot of Rejecting an EM Work Order scenario three", ((string)(null)), ((global::Reqnroll.Table)(null)), "And ");
#line hidden
            }
            await this.ScenarioCleanupAsync();
        }
...
#line hidden
                ...
                table253.AddRow(new string[] {
                            ...
                            "=EM"});
#line 107
    await testRunner.WhenAsync("I filter table Quick Work Order:", ((string)(null)), table253, "When ");
#line hidden
#line 110
    await testRunner.AndAsync("I select no. 1 record from EM table", ((string)(null)), ((global::Reqnroll.Table)(null)), "And ");
#line hidden
...
#line hidden
                ...
                table254.AddRow(new string[] {
                            "ABRACE"});
#line 121
     await testRunner.AndAsync("I filter table Record labor:", ((string)(null)), table254, "And ");
#line hidden
#line 124
...
#line 140
    await testRunner.AndAsync("I enter following:", ((string)(null)), table255, "And ");
#line hidden
#line 143
    await testRunner.AndAsync("I save", ((string)(null)), ((global::Reqnroll.Table)(null)), "And ");
#line hidden
...
#line hidden
#line 149
    await testRunner.AndAsync("I take screenshot of Rejecting an EM Work Order test scenario four", ((string)(null)), ((global::Reqnroll.Table)(null)), "And ");
#line hidden
            }
            await this.ScenarioCleanupAsync();
        }
        ...
        [global::NUnit.Framework.TestAttribute()]
        [global::NUnit.Framework.DescriptionAttribute("05) Rejecting an EM Work Order")]
        [global::NUnit.Framework.TestCaseAttribute("teamlead", "4", null)]
        public async global::System.Threading.Tasks.Task _05RejectingAnEMWorkOrder(string role, string @__pickleIndex, string[] exampleTags)
        {
            string[] tagsOfScenario = exampleTags;
            global::System.Collections.Specialized.OrderedDictionary argumentsOfScenario = new global::System.Collections.Specialized.OrderedDictionary();
            argumentsOfScenario.Add("role", role);
            string pickleIndex = @__pickleIndex;
            global::Reqnroll.ScenarioInfo scenarioInfo = new global::Reqnroll.ScenarioInfo("05) Rejecting an EM Work Order", null, tagsOfScenario, argumentsOfScenario, featureTags, pickleIndex);
            string[] tagsOfRule = ((string[])(null));
            global::Reqnroll.RuleInfo ruleInfo = null;
#line 157
this.ScenarioInitialize(scenarioInfo, ruleInfo);
...
#line hidden
                ...
                table256.AddRow(new string[] {
                            ...
                            "=EM"});
#line 160
    await testRunner.WhenAsync("I filter table EM:", ((string)(null)), table256, "When ");
#line hidden
#line 163
    await testRunner.AndAsync("I select no. 1 record from EM table", ((string)(null)), ((global::Reqnroll.Table)(null)), "And ");
#line hidden
...
#line hidden
#line 165
 await testRunner.AndAsync("I set (Radio) field to \"Reject this Work Order\"", ((string)(null)), ((global::Reqnroll.Table)(null)), "And ");
#line hidden
#line 166
 await testRunner.AndAsync("I press OK button", ((string)(null)), ((global::Reqnroll.Table)(null)), "And ");
#line hidden
#line 167
 await testRunner.AndAsync("I Status field has value INPRG-HOLD", ((string)(null)), ((global::Reqnroll.Table)(null)), "And ");
#line hidden
#line 168
 await testRunner.AndAsync("I take screenshot of Rejecting an EM Work Order test scenario five", ((string)(null)), ((global::Reqnroll.Table)(null)), "And ");
#line hidden
            }
            await this.ScenarioCleanupAsync();
        }
