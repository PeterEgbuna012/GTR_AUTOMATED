Feature: GTR-UAT-RTS-028 Move Request Tab - Update an Existing Move Request

As a Panel Operations Manager, Engineer, Shunter, I want to make an amendment to a Move Request I previously created
...
Scenario: 03) Create a Move Request
	...
	And I take screenshot of Create a Move Request Test Scenario
...
Scenario: 04) Move Request Tab - Update an Existing Move Request
	Given I sign as <role>
	And I open application Depot Management (BRDF)
	And I filter table Yard Asset:
       | Yard Asset | 
	...
	And I select action Manage Move Request
	And I modify Move By Date field
	And I Open select value lookup of Destination
	...
	And I take screenshot of Update Move Request Details Test Scenario
