...
namespace GTR_AUTOMATED.Features.MaterialsManagement.ExpeditingProcess
{
    ...
    [global::NUnit.Framework.DescriptionAttribute("0.0.6 - Approving a PR - Non-stocked Item")]
    ...
    public partial class _0_0_6_ApprovingAPR_Non_StockedItemFeature
    {
        ...
        private static global::Reqnroll.FeatureInfo featureInfo = new global::Reqnroll.FeatureInfo(new global::System.Globalization.CultureInfo("en-US"), "Features/Materials Management/Expediting Process", "0.0.6 - Approving a PR - Non-stocked Item", "PRs to review - non-intervention", global::Reqnroll.ProgrammingLanguage.CSharp, featureTags, InitializeCucumberMessages());
...
#line hidden
        ...
        {
            return new global::Reqnroll.Formatters.RuntimeSupport.FeatureLevelCucumberMessages("Features/Materials Management/Expediting Process/GTR-UAT-EXP-006.feature.ndjson", 4);
        }
        
        [global::NUnit.Framework.TestAttribute()]
        [global::NUnit.Framework.DescriptionAttribute("01) Raising a Purchase Requisition - Non-stocked Item")]
        [global::NUnit.Framework.CategoryAttribute("Feature:0.0.6-ApprovingaPR-Non-stockedItem")]
        [global::NUnit.Framework.TestCaseAttribute("materials supply chain support", "0", null)]
        public async global::System.Threading.Tasks.Task _01RaisingAPurchaseRequisition_Non_StockedItem(string role, string @__pickleIndex, string[] exampleTags)
        {
            ...
            global::Reqnroll.ScenarioInfo scenarioInfo = new global::Reqnroll.ScenarioInfo("01) Raising a Purchase Requisition - Non-stocked Item", null, tagsOfScenario, argumentsOfScenario, featureTags, pickleIndex);
...
#line 12
   await testRunner.AndAsync("I enter following Purchase Requisition:", ((string)(null)), table436, "And ");
#line hidden
#line 15
...
#line 17
  await testRunner.AndAsync("I filter table Company Field:", ((string)(null)), table437, "And ");
#line hidden
#line 20
...
#line hidden
                ...
                table438.AddRow(new string[] {
                            ...
                            "100"});
#line 26
  await testRunner.AndAsync("I enter following Material Details:", ((string)(null)), table438, "And ");
#line hidden
#line 29
...
#line hidden
                ...
                table439.AddRow(new string[] {
                            ...
                            "=COMP-WREV"});
#line 32
  await testRunner.AndAsync("I filter table CM Work Order:", ((string)(null)), table439, "And ");
#line hidden
#line 35
...
#line hidden
                ...
                table440.AddRow(new string[] {
                            "GTR-HE"});
#line 39
  await testRunner.AndAsync("I filter table Ship To:", ((string)(null)), table440, "And ");
#line hidden
#line 42
...
#line hidden
        ...
        [global::NUnit.Framework.TestAttribute()]
        [global::NUnit.Framework.DescriptionAttribute("02) Approving a PR -  Non-stocked Item")]
        [global::NUnit.Framework.TestCaseAttribute("materials controller", "1", null)]
        public async global::System.Threading.Tasks.Task _02ApprovingAPR_Non_StockedItem(string role, string @__pickleIndex, string[] exampleTags)
        {
            string[] tagsOfScenario = exampleTags;
            global::System.Collections.Specialized.OrderedDictionary argumentsOfScenario = new global::System.Collections.Specialized.OrderedDictionary();
            argumentsOfScenario.Add("role", role);
            string pickleIndex = @__pickleIndex;
            global::Reqnroll.ScenarioInfo scenarioInfo = new global::Reqnroll.ScenarioInfo("02) Approving a PR -  Non-stocked Item", null, tagsOfScenario, argumentsOfScenario, featureTags, pickleIndex);
            string[] tagsOfRule = ((string[])(null));
            global::Reqnroll.RuleInfo ruleInfo = null;
#line 63
this.ScenarioInitialize(scenarioInfo, ruleInfo);
...
#line hidden
                ...
                table441.AddRow(new string[] {
                            "Approving a PR Non stocked Item Test"});
#line 65
  await testRunner.AndAsync("I filter Portlet table Purchase Requisition:", ((string)(null)), table441, "And ");
#line hidden
#line 68
...
#line hidden
                ...
                table442.AddRow(new string[] {
                            "10"});
#line 71
 await testRunner.AndAsync("I enter quantity:", ((string)(null)), table442, "And ");
#line hidden
#line 74
 await testRunner.AndAsync("I save record", ((string)(null)), ((global::Reqnroll.Table)(null)), "And ");
#line hidden
...
#line 78
 await testRunner.AndAsync("I enter following Item data:", ((string)(null)), table443, "And ");
#line hidden
#line 81
 await testRunner.AndAsync("I save record", ((string)(null)), ((global::Reqnroll.Table)(null)), "And ");
#line hidden
...
#line hidden
                ...
                table444.AddRow(new string[] {
                            ...
                            "=APPR"});
#line 87
 await testRunner.AndAsync("I filter table Purchase Orders (Tr):", ((string)(null)), table444, "And ");
#line hidden
#line 90
...
#line hidden
                ...
                table445.AddRow(new string[] {
                            ...
                            "Approving a PR Non stocked Item Test"});
#line 99
 await testRunner.AndAsync("I enter following PO Work Log data:", ((string)(null)), table445, "And ");
#line hidden
#line 102
 await testRunner.AndAsync("I save record", ((string)(null)), ((global::Reqnroll.Table)(null)), "And ");
#line hidden
