...
namespace GTR_AUTOMATED.Features.MaterialsManagement.ExpeditingProcess
{
    ...
    public partial class _0_0_5_ApprovingAPR_StockedItemFeature
    {
        ...
        private static global::Reqnroll.FeatureInfo featureInfo = new global::Reqnroll.FeatureInfo(new global::System.Globalization.CultureInfo("en-US"), "Features/Materials Management/Expediting Process", "0.0.5 - Approving a PR - Stocked Item", "PRs to review - non-intervention", global::Reqnroll.ProgrammingLanguage.CSharp, featureTags, InitializeCucumberMessages());
...
#line hidden
        ...
        {
            return new global::Reqnroll.Formatters.RuntimeSupport.FeatureLevelCucumberMessages("Features/Materials Management/Expediting Process/GTR-UAT-EXP-005.feature.ndjson", 4);
        }
...
#line 11
  await testRunner.AndAsync("I enter following Purchase Requisition:", ((string)(null)), table425, "And ");
#line hidden
#line 14
...
#line 16
 await testRunner.AndAsync("I filter table Company Field:", ((string)(null)), table426, "And ");
#line hidden
#line 19
...
#line hidden
                ...
                table427.AddRow(new string[] {
                            "039/140100"});
#line 24
  await testRunner.AndAsync("I filter table Vendor Items:", ((string)(null)), table427, "And ");
#line hidden
#line 27
...
#line hidden
                ...
                table428.AddRow(new string[] {
                            "HE-VALUE"});
#line 30
 await testRunner.AndAsync("I filter table Storeroom:", ((string)(null)), table428, "And ");
#line hidden
#line 33
...
#line hidden
                ...
                table429.AddRow(new string[] {
                            "00000-00000-0000"});
#line 34
 await testRunner.AndAsync("I enter GL Debit Account:", ((string)(null)), table429, "And ");
#line hidden
#line 37
...
#line hidden
                ...
                table430.AddRow(new string[] {
                            "100"});
#line 38
 await testRunner.AndAsync("I enter  Conversion Factor:", ((string)(null)), table430, "And ");
#line hidden
#line 41
...
#line hidden
                ...
                table432.AddRow(new string[] {
                            "Approving a PR - Stocked Item Test"});
#line 68
  await testRunner.AndAsync("I filter Portlet table Purchase Requisition:", ((string)(null)), table432, "And ");
#line hidden
#line 71
...
#line 77
 await testRunner.AndAsync("I enter following Item data:", ((string)(null)), table433, "And ");
#line hidden
#line 80
 await testRunner.AndAsync("I save record", ((string)(null)), ((global::Reqnroll.Table)(null)), "And ");
#line hidden
...
#line hidden
                ...
                table434.AddRow(new string[] {
                            ...
                            "APPR"});
#line 86
 await testRunner.AndAsync("I filter table Purchase Orders (Tr):", ((string)(null)), table434, "And ");
#line hidden
#line 89
...
#line hidden
                ...
                table435.AddRow(new string[] {
                            ...
                            "Approving a PR - Stocked Item Auto Test"});
#line 99
 await testRunner.AndAsync("I enter following PO Work Log data:", ((string)(null)), table435, "And ");
#line hidden
#line 102
 await testRunner.AndAsync("I save record", ((string)(null)), ((global::Reqnroll.Table)(null)), "And ");
#line hidden
