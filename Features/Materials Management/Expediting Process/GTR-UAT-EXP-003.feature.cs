...
namespace GTR_AUTOMATED.Features.MaterialsManagement.ExpeditingProcess
{
    ...
    [global::NUnit.Framework.DescriptionAttribute("0.0.3 - Raising a Purchase Requisition - Stocked Item")]
    ...
    public partial class _0_0_3_RaisingAPurchaseRequisition_StockedItemFeature
    {
        ...
        private static global::Reqnroll.FeatureInfo featureInfo = new global::Reqnroll.FeatureInfo(new global::System.Globalization.CultureInfo("en-US"), "Features/Materials Management/Expediting Process", "0.0.3 - Raising a Purchase Requisition - Stocked Item", "There is demand in the storeroom that has not been met by the automatic reorder p" +
...
#line hidden
        ...
        {
            return new global::Reqnroll.Formatters.RuntimeSupport.FeatureLevelCucumberMessages("Features/Materials Management/Expediting Process/GTR-UAT-EXP-003.feature.ndjson", 3);
        }
        
        [global::NUnit.Framework.TestAttribute()]
        [global::NUnit.Framework.DescriptionAttribute("Raising a Purchase Requisition - Stocked Item")]
        [global::NUnit.Framework.CategoryAttribute("Feature:0.0.3-RaisingaPurchaseRequisition-StockedItem")]
        [global::NUnit.Framework.TestCaseAttribute("materials supply chain support", "0", null)]
        public async global::System.Threading.Tasks.Task RaisingAPurchaseRequisition_StockedItem(string role, string @__pickleIndex, string[] exampleTags)
        {
            ...
            global::Reqnroll.ScenarioInfo scenarioInfo = new global::Reqnroll.ScenarioInfo("Raising a Purchase Requisition - Stocked Item", null, tagsOfScenario, argumentsOfScenario, featureTags, pickleIndex);
...
#line 11
 await testRunner.AndAsync("I enter following Purchase Requisition:", ((string)(null)), table414, "And ");
#line hidden
#line 14
...
#line 16
 await testRunner.AndAsync("I filter table Company Field:", ((string)(null)), table415, "And ");
#line hidden
#line 19
...
#line hidden
                ...
                table416.AddRow(new string[] {
                            "039/140100"});
#line 24
    await testRunner.AndAsync("I filter table Vendor Items:", ((string)(null)), table416, "And ");
#line hidden
#line 27
...
#line hidden
                ...
                table417.AddRow(new string[] {
                            "HE-VALUE"});
#line 30
 await testRunner.AndAsync("I filter table Storeroom:", ((string)(null)), table417, "And ");
#line hidden
#line 33
...
#line hidden
                ...
                table418.AddRow(new string[] {
                            "00000-00000-0000"});
#line 34
 await testRunner.AndAsync("I enter GL Debit Account:", ((string)(null)), table418, "And ");
#line hidden
#line 37
...
#line hidden
                ...
                table419.AddRow(new string[] {
                            "4"});
#line 38
 await testRunner.AndAsync("I enter  Conversion Factor:", ((string)(null)), table419, "And ");
#line hidden
#line 41
