...
namespace GTR_AUTOMATED.Features.MaterialsManagement.ExpeditingProcess
{
    ...
    public partial class _0_0_4_RaisingAPurchaseRequisition_Non_StockedItemFeature
    {
        ...
        private static global::Reqnroll.FeatureInfo featureInfo = new global::Reqnroll.FeatureInfo(new global::System.Globalization.CultureInfo("en-US"), "Features/Materials Management/Expediting Process", "0.0.4 - Raising a Purchase Requisition - Non-stocked Item", "There is demand in the storeroom that has not been met by the automatic reorder p" +
...
#line hidden
        ...
        {
            return new global::Reqnroll.Formatters.RuntimeSupport.FeatureLevelCucumberMessages("Features/Materials Management/Expediting Process/GTR-UAT-EXP-004.feature.ndjson", 3);
        }
...
#line 12
    await testRunner.AndAsync("I enter following Purchase Requisition:", ((string)(null)), table420, "And ");
#line hidden
#line 15
...
#line 17
 await testRunner.AndAsync("I filter table Company Field:", ((string)(null)), table421, "And ");
#line hidden
#line 20
...
#line hidden
                ...
                table422.AddRow(new string[] {
                            ...
                            "100"});
#line 26
 await testRunner.AndAsync("I enter following Material Details:", ((string)(null)), table422, "And ");
#line hidden
#line 29
...
#line hidden
                ...
                table423.AddRow(new string[] {
                            ...
                            "=COMP-WREV"});
#line 32
    await testRunner.AndAsync("I filter table CM Work Order:", ((string)(null)), table423, "And ");
#line hidden
#line 35
...
#line hidden
                ...
                table424.AddRow(new string[] {
                            "GTR-HE"});
#line 44
 await testRunner.AndAsync("I filter table Ship To:", ((string)(null)), table424, "And ");
#line hidden
#line 47
