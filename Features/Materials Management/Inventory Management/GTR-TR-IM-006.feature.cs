...
namespace GTR_AUTOMATED.Features.MaterialsManagement.InventoryManagement
{
    ...
    [global::NUnit.Framework.DescriptionAttribute("0.0.6 - Inter-depot Transfer")]
    ...
    public partial class _0_0_6_Inter_DepotTransferFeature
    {
        ...
        private static global::Reqnroll.FeatureInfo featureInfo = new global::Reqnroll.FeatureInfo(new global::System.Globalization.CultureInfo("en-US"), "Features/Materials Management/Inventory Management", "0.0.6 - Inter-depot Transfer", "A Materials Team Lead is required to transfer material from one depot to another " +
                "attaching shipment paperwork as appropriate.", global::Reqnroll.ProgrammingLanguage.CSharp, featureTags, InitializeCucumberMessages());
...
#line hidden
        ...
        {
            return new global::Reqnroll.Formatters.RuntimeSupport.FeatureLevelCucumberMessages("Features/Materials Management/Inventory Management/GTR-TR-IM-006.feature.ndjson", 3);
        }
        
        [global::NUnit.Framework.TestAttribute()]
        [global::NUnit.Framework.DescriptionAttribute("Inter-depot Transfer")]
        [global::NUnit.Framework.CategoryAttribute("Feature:0.0.6-Inter-depotTransfer")]
        [global::NUnit.Framework.TestCaseAttribute("materials depot manager", "0", null)]
        public async global::System.Threading.Tasks.Task Inter_DepotTransfer(string role, string @__pickleIndex, string[] exampleTags)
        {
            ...
            global::Reqnroll.ScenarioInfo scenarioInfo = new global::Reqnroll.ScenarioInfo("Inter-depot Transfer", null, tagsOfScenario, argumentsOfScenario, featureTags, pickleIndex);
...
#line 10
    await testRunner.AndAsync("I enter asset description:", ((string)(null)), table482, "And ");
#line hidden
#line 13
...
#line hidden
                ...
                table483.AddRow(new string[] {
                            "SL-Z-VALUE"});
#line 14
     await testRunner.AndAsync("I filter table Storeroom:", ((string)(null)), table483, "And ");
#line hidden
#line 17
...
#line hidden
                ...
                table484.AddRow(new string[] {
                            "093/050493"});
#line 22
    await testRunner.AndAsync("I filter table Item:", ((string)(null)), table484, "And ");
#line hidden
#line 25
...
#line hidden
                ...
                table485.AddRow(new string[] {
                            "BI-Z-VALUE"});
#line 27
    await testRunner.AndAsync("I filter Storeroom:", ((string)(null)), table485, "And ");
#line hidden
#line 30
...
#line hidden
                ...
                table486.AddRow(new string[] {
                            "GTR-BI"});
#line 36
     await testRunner.AndAsync("I filter Ship To:", ((string)(null)), table486, "And ");
#line hidden
#line 39
...
#line 42
    await testRunner.AndAsync("I filter table Shipment Reports:", ((string)(null)), table487, "And ");
#line hidden
#line 45
