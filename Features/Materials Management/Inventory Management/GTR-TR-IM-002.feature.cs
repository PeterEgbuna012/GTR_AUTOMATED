...
namespace GTR_AUTOMATED.Features.MaterialsManagement.InventoryManagement
{
    ...
    [global::NUnit.Framework.DescriptionAttribute("0.0.2 - Issue Rotating Assets to a Work Order")]
    ...
    public partial class _0_0_2_IssueRotatingAssetsToAWorkOrderFeature
    {
        ...
        private static global::Reqnroll.FeatureInfo featureInfo = new global::Reqnroll.FeatureInfo(new global::System.Globalization.CultureInfo("en-US"), "Features/Materials Management/Inventory Management", "0.0.2 - Issue Rotating Assets to a Work Order", "As a Stores Person Issue Rotating Items to a Work Order, specifying the unique as" +
                "sets that have been issued.", global::Reqnroll.ProgrammingLanguage.CSharp, featureTags, InitializeCucumberMessages());
...
#line hidden
        ...
        {
            return new global::Reqnroll.Formatters.RuntimeSupport.FeatureLevelCucumberMessages("Features/Materials Management/Inventory Management/GTR-TR-IM-002.feature.ndjson", 7);
        }
        
        [global::NUnit.Framework.TestAttribute()]
        [global::NUnit.Framework.DescriptionAttribute("01) Raising a Fault")]
        [global::NUnit.Framework.CategoryAttribute("Feature:0.0.2-IssueRotatingAssetstoaWorkOrder")]
...
#line hidden
                ...
                table450.AddRow(new string[] {
                            "TAUTO"});
#line 22
    await testRunner.AndAsync("I enter following data to Headcode:", ((string)(null)), table450, "And ");
#line hidden
...
#line 25
    await testRunner.AndAsync("I enter following data:", ((string)(null)), table451, "And ");
#line hidden
#line 28
...
#line hidden
                ...
                table452.AddRow(new string[] {
                            ...
                            "=EM"});
#line 48
     await testRunner.WhenAsync("I filter table EM:", ((string)(null)), table452, "When ");
#line hidden
#line 51
...
#line hidden
                ...
                table453.AddRow(new string[] {
                            ...
                            "=EM"});
#line 69
      await testRunner.WhenAsync("I filter table EM:", ((string)(null)), table453, "When ");
#line hidden
#line 72
     await testRunner.AndAsync("I select no. 1 record from EM table", ((string)(null)), ((global::Reqnroll.Table)(null)), "And ");
#line hidden
...
#line hidden
                ...
                table454.AddRow(new string[] {
                            "ABRACE"});
#line 76
     await testRunner.AndAsync("I filter table labor:", ((string)(null)), table454, "And ");
#line hidden
#line 79
...
#line hidden
                ...
                table455.AddRow(new string[] {
                            ...
                            "=EM"});
#line 96
    await testRunner.WhenAsync("I filter table Quick Work Order:", ((string)(null)), table455, "When ");
#line hidden
#line 99
    await testRunner.AndAsync("I select no. 1 record from EM table", ((string)(null)), ((global::Reqnroll.Table)(null)), "And ");
#line hidden
...
#line hidden
                ...
                table456.AddRow(new string[] {
                            "ABRACE"});
#line 110
     await testRunner.AndAsync("I filter table Record labor:", ((string)(null)), table456, "And ");
#line hidden
#line 113
...
#line hidden
                ...
                table457.AddRow(new string[] {
                            ...
                            "Issue Rotating Assets to a Work Order Test"});
#line 129
    await testRunner.AndAsync("I enter following:", ((string)(null)), table457, "And ");
#line hidden
#line 132
...
#line hidden
        ...
        [global::NUnit.Framework.TestAttribute()]
        [global::NUnit.Framework.DescriptionAttribute("05) Issue Rotating Assets to a Work Order")]
        [global::NUnit.Framework.TestCaseAttribute("store", "4", null)]
        public async global::System.Threading.Tasks.Task _05IssueRotatingAssetsToAWorkOrder(string role, string @__pickleIndex, string[] exampleTags)
        {
            string[] tagsOfScenario = exampleTags;
            global::System.Collections.Specialized.OrderedDictionary argumentsOfScenario = new global::System.Collections.Specialized.OrderedDictionary();
            argumentsOfScenario.Add("role", role);
            string pickleIndex = @__pickleIndex;
            global::Reqnroll.ScenarioInfo scenarioInfo = new global::Reqnroll.ScenarioInfo("05) Issue Rotating Assets to a Work Order", null, tagsOfScenario, argumentsOfScenario, featureTags, pickleIndex);
            string[] tagsOfRule = ((string[])(null));
            global::Reqnroll.RuleInfo ruleInfo = null;
#line 148
this.ScenarioInitialize(scenarioInfo, ruleInfo);
...
#line hidden
                ...
                table458.AddRow(new string[] {
                            "Issue Rotating Assets to a Work Order"});
#line 152
   await testRunner.AndAsync("I enter asset description:", ((string)(null)), table458, "And ");
#line hidden
#line 155
...
#line hidden
                ...
                table459.AddRow(new string[] {
                            "SL-Z-VALUE"});
#line 156
   await testRunner.AndAsync("I filter table Storeroom:", ((string)(null)), table459, "And ");
#line hidden
#line 159
...
#line hidden
                ...
                table460.AddRow(new string[] {
                            "093/051329"});
#line 164
   await testRunner.AndAsync("I filter table Item:", ((string)(null)), table460, "And ");
#line hidden
#line 167
...
#line hidden
                ...
                table461.AddRow(new string[] {
                            "Issue Rotating Assets to a Work Order"});
#line 169
   await testRunner.AndAsync("I filter work Order table:", ((string)(null)), table461, "And ");
#line hidden
#line 172
...
#line hidden
                ...
                table462.AddRow(new string[] {
                            "MAT-ASS-2726"});
#line 186
   await testRunner.AndAsync("I filter Asset table:", ((string)(null)), table462, "And ");
#line hidden
#line 189
